        ...
        <div className="max-w-xl mx-auto">
          {education.map((edu, i) => (
            <motion.div
              ...
              className="rounded-xl border border-border bg-white dark:bg-slate-900 shadow-sm p-6 md:p-8 hover:shadow-md hover:border-teal-200 transition-all text-center"
            >
