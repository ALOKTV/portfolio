  ...
  return (
    <footer className="relative border-t border-border bg-white">
          ...
          <div className="flex items-center gap-3">
            {socialLinks.map((link) => (
              <a
                ...
                className="w-9 h-9 rounded-lg border border-border bg-white flex items-center justify-center hover:border-teal-200 hover:text-accent hover:bg-teal-50/30 transition-all shadow-sm"
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.9 }}
        className="fixed bottom-8 right-8 w-12 h-12 rounded-lg bg-white border border-border shadow-lg flex items-center justify-center hover:border-teal-200 hover:text-accent hover:shadow-teal-200/40 transition-all z-40 cursor-pointer"
